...
class UsersStacked extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        Transform(
          transform: Matrix4.identity()..rotate(vector.Vector3(1, 0, 0), 0.3),
        ...
        Transform(
          transform: Matrix4.identity()..rotate(vector.Vector3(1, 0, 0), 0.40),
          child: const UserCard(
            position: 1.3,
        ...
        Transform(
          transform: Matrix4.identity()..rotate(vector.Vector3(1, 0, 0), 0.5),
          child: const UserCard(
            position: 1.2,
            userImage: 'https://ath2.unileverservices.com/wp-content/uploads/sites/4/2020/02/IG-annvmariv-1024x1016.jpg',
            color: Colors.purple,
        ...
        Transform(
          transform: Matrix4.identity()..rotate(vector.Vector3(1, 0, 0), 0.60),
          child: const UserCard(
            position: 1.1,
